...
@Component({
  ...
  standalone: true,
  imports: [CognosDialogSurfaceComponent, CognosButtonComponent, ProfilePictureComponent],
  template: `
    <cog-dialog-surface
      ...
      <div class="contact-help-dialog">
        <div class="contact-help-dialog__copy">
          <p>
            ...
            <a href="https://www.linkedin.com/in/egjones/" rel="noreferrer" target="_blank"
              >Ewan</a
            >
          ...
          <ul>
            ...
            <li>
              Threema:
              <a href="https://threema.id/NM4AVD9N" rel="noreferrer" target="_blank"
                >NM4AVD9N</a
              >
            </li>
          </ul>
