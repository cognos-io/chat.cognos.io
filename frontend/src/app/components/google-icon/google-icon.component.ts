...
// GoogleIconComponent renders the official Google "G" mark inline, used on
// the "Continue with Google" buttons (login, register, account security).
// aria-hidden: the button it sits in always carries its own accessible text.
@Component({
