    ...
    <div class="auth-page">
      <section class="auth-page__card">
        ...
        <p class="auth-page__lead">
          This reset link cannot be completed because Cognos does not yet support safe
          vault recovery for encrypted backups.
        </p>
        <p class="auth-page__lead">
          Password reset will stay disabled until we can re-wrap encrypted key material
          without weakening the current security model.
        </p>
