...
export type ConversationPublicKeysResponse<Texpand = unknown> = Required<ConversationPublicKeysRecord> & BaseSystemFields<Texpand>
export type ConversationSecretKeysResponse<Texpand = unknown> = Required<ConversationSecretKeysRecord> & BaseSystemFields<Texpand>
...
export type UserKeyPairsResponse<Texpand = unknown> = Required<UserKeyPairsRecord> & BaseSystemFields<Texpand>
...
export type TypedPocketBase = PocketBase & {
	collection(idOrName: 'conversation_public_keys'): RecordService<ConversationPublicKeysResponse>
	collection(idOrName: 'conversation_secret_keys'): RecordService<ConversationSecretKeysResponse>
