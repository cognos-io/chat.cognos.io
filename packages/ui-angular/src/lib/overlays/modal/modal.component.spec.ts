...
describe("CognosModalComponent", () => {
  ...
  it("renders the panel with the configured title and width", () => {
    ...
    const panel = fixture.nativeElement.querySelector(".cog-modal__panel") as HTMLElement;
    const title = fixture.nativeElement.querySelector(".cog-modal__title");

    expect(panel).toBeTruthy();
    expect(panel.style.getPropertyValue("--cog-modal-width")).toBe("720px");
  ...
  it("emits close when the scrim is clicked", () => {
    ...
    (fixture.nativeElement.querySelector(".cog-modal__scrim") as HTMLButtonElement).click();
