  ...
  render: () => ({
    ...
    template: `
      <div style="display:grid; gap:24px; width:100%; max-width:980px; color:var(--cog-text);">
        ...
        <section style="border:var(--cog-border-width) solid var(--cog-border); border-radius:var(--cog-radius-md); background:var(--cog-surface); overflow:hidden;"><cog-vault-list-row [file]="files[1]" /><cog-vault-list-row [file]="files[3]" [top]="true" /></section>
