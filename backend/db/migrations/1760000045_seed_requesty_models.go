	...
	m.Register(func(app core.App) error {
		...
		for _, model := range []requestyModelSeed{
			...
			},
			{
				...
				providerModelID:    "vertex/claude-sonnet-4-6@europe-west1",
			...
			},
			{
				...
				providerModelID:    "vertex/claude-haiku-4-5@europe-west1",
			...
			},
			{
				...
				providerModelID:    "bedrock/kimi-k2.5@eu-north-1",
			...
			},
			{
				...
				providerModelID:    "coding/gemini-2.5-pro@europe-west1",
			...
			},
			{
				...
				providerModelID:    "coding/gemini-2.5-flash@europe-west1",
