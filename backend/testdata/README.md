...
The test database lives in `testdata/pb_data` and can be populated by running `make run/test`. This
will start a normal Pocketbase instance but using the test database. Log in with the `Admin` user
above and populate as necessary.
