...
| Organisation billing checkout | `POST /orgs/{id}/billing/checkout` (Paddle checkout, quantity=1, custom_data.org_id)                                                                                                                               | org owner                                                                   | `org_billing_api_test.go`                                                                              |
...
| Organisation invites          | `POST /orgs/{id}/invites`, `GET /orgs/{id}/invites`, `DELETE /orgs/{id}/invites/{inviteID}` (token returned once, stored hashed)                                                                                   | org admin                                                                   | `org_invites_api_test.go`                                                                              |
| Organisation invite accept    | `POST /org-invites/accept` (neutral 404 for unknown/expired/consumed; reactivates soft-revoked membership)                                                                                                         | any authed (token-gated)                                                    | `org_invites_api_test.go`                                                                              |
| Organisation member offboard  | `DELETE /orgs/{id}/members/{userID}` (revoke membership + org-project participation + pending seat decrement, one tx)                                                                                              | org admin (owner self 400; admin-vs-owner 403)                              | `org_invites_api_test.go`                                                                              |
