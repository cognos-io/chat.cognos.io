...
| ID     | Priority    | Open point                                                                                                                                                                                       | Recommendation                                                                                                                                                                                 |
| ------ | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OP-011 | P0 external | Plausible sites, goals and operator MFA are in place and app emission is on; a content-free live smoke after deploy is not yet evidenced. Native funnels deferred - approximate from goal rates. | After production deploy, run the live smoke on the [dashboard checklist](./operations/analytics-dashboard.md) and record sign-off.                                                             |
...
Closed by decision (removed from the queue): OP-015 non-English legal bodies. Privacy and Terms ship
in English for the time being, which `web/scripts/check-marketing-contracts.mjs` now pins in both
directions; the Refund Policy is translated in all six locales and required there. Native-speaker
review of the AI-drafted product catalogues went with that entry and is currently unscheduled.
