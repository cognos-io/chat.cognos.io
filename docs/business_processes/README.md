...
| Completions   | [completion-pipeline](./completion-pipeline.md) · [reasoning-visibility](./reasoning-visibility.md) · [privacy-tier-gating](./privacy-tier-gating.md) · [billing-access-gate](./billing-access-gate.md) · [usage-cost-calculation](./usage-cost-calculation.md) · [usage-ledger](./usage-ledger.md) · [analytics-emit](./analytics-emit.md) |
