...
END
\$\$;"
psql -c "GRANT CONNECT ON DATABASE ${POSTGRESQL_DATABASE} TO ${POSTGRES_RO_USER};"
psql -c "GRANT USAGE ON SCHEMA public TO ${POSTGRES_RO_USER};"
psql -c "GRANT USAGE ON ALL SEQUENCES IN SCHEMA public TO ${POSTGRES_RO_USER};"
psql -c "GRANT SELECT ON ALL TABLES IN SCHEMA public TO ${POSTGRES_RO_USER};"
psql -c "ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT ON TABLES TO ${POSTGRES_RO_USER};"
